				...
				<div className={styles.container}>
					<div className={styles.heroContent}>
						<div className={styles.discordBanner}>
							...
							<span>Feedback is now collected preferrably via Discord</span>
						</div>
						<h1>Share Your Feedback</h1>
						<p>
							We're moving feedback collection to our Discord community to foster better collaboration and faster responses. Discord

...
interface FireHazardsViewToggleProps {
...
/**
 * FireHazardsViewToggle - Wrapper component with view toggle buttons
 *
 * Provides a header with Map/Table toggle buttons above the FireHazards component
 */
const FireHazardsViewToggle = ({ alerts, displayOffshores, initialView = 'map' }: FireHazardsViewToggleProps) => {
	...
	return (
		<div className={styles.fireHazardsViewToggle}>
			...
			<div className={styles.content}>
				<FireHazards alerts={alerts} displayOffshores={displayOffshores} view={view} />
			</div>
		</div>
	)
}

export default FireHazardsViewToggle

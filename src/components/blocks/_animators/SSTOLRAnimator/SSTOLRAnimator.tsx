		...
		<>
			<div className={styles.sstolrAnimatorContainer}>
				<Animator
					...
					playbackFps={climateSSTOLRFrameRate}
					setPlaybackFps={setClimateSSTOLRFrameRate}
					interval={1000 / climateSSTOLRFrameRate}
					lastFrameDwell={climateSSTOLRLastFrameDwell}
					edgeDwellSeconds={climateSSTOLRLastFrameDwellTime}
					setEdgeDwellSeconds={setClimateSSTOLRLastFrameDwellTime}

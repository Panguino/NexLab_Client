...
Default.args = {
  ...
  featurePanels: [
    { title: 'Analysis', description: 'Mesoscale diagnosis', href: '/weather-data/analysis', image: 'https://picsum.photos/600/400', linkText: 'View' },
    { title: 'Radar', description: 'Situational awareness', href: '/weather-data/radar', image: 'https://picsum.photos/600/401', linkText: 'Explore' },

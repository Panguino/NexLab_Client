...
const AnalysisAnimatorSettings = ({ refreshData }) => {
	...
	const { timeRemaining } = useIntervalWithCountdown(refreshAlertData, analysisDataRefreshInterval * 60 * 1000)
...
export default AnalysisAnimatorSettings

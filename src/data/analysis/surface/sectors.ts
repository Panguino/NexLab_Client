...
import { ALL_SURFACE_PRODUCTS, SURFACE_PRODUCT_DECODED_OBS, SURFACE_PRODUCT_METARS, SURFACE_PRODUCT_RAW } from './products'

// Products for large sectors (excludes METARs and Decoded Obs)
const LARGE_SECTOR_PRODUCTS = Object.fromEntries(
	Object.entries(ALL_SURFACE_PRODUCTS).filter(([key]) => key !== SURFACE_PRODUCT_METARS && key !== SURFACE_PRODUCT_DECODED_OBS),
)
...
export const LARGE_SURFACE_SECTORS = {
	[SECTOR_US]: {
		...
		products: LARGE_SECTOR_PRODUCTS,
	},
	[SECTOR_CANADA]: {
		name: 'Canada',
		type: 'Geobox',
...
export const STATE_SURFACE_SECTORS = {
	[SECTOR_CHI_METRO]: {
		...
		products: {
			[SURFACE_PRODUCT_RAW]: ALL_SURFACE_PRODUCTS[SURFACE_PRODUCT_RAW],
		},
	},
	[SECTOR_SF_BAY]: {
	...
	[SECTOR_ALASKA]: {
		...
		products: {
			[SURFACE_PRODUCT_RAW]: ALL_SURFACE_PRODUCTS[SURFACE_PRODUCT_RAW],
			[SURFACE_PRODUCT_METARS]: ALL_SURFACE_PRODUCTS[SURFACE_PRODUCT_METARS],
			[SURFACE_PRODUCT_DECODED_OBS]: ALL_SURFACE_PRODUCTS[SURFACE_PRODUCT_DECODED_OBS],
		},
	},
	[SECTOR_ALABAMA]: {
		name: 'Alabama',

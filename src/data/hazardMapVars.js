...
export const HAZARD_LEVELS = [HAZARD_LEVEL_WARNING_ID, HAZARD_LEVEL_WATCH_ID, HAZARD_LEVEL_ADVISORY_ID, HAZARD_LEVEL_STATEMENT_ID]

export const HAZARD_TYPE_TORNADO_ID = 'tor'
export const HAZARD_TYPE_SEVERE_ID = 'svr'

...
// Global Sectors
// commented sectors are either private or deprecated -- still may be useful in the future
// large sectors if the still exist might need to be accessed somehow
// southern hemisphere sectors miiiight come back

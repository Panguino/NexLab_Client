...
export const SATRAD_SCALE_MESO_ID = 'meso'
...
export const SATRAD_SCALE_REGION_MESO_EAST_ID = `${SATRAD_SCALE_MESO_ID}-${SATRAD_REGION_GOES_EAST_ID}`
export const SATRAD_SCALE_REGION_MESO_WEST_ID = `${SATRAD_SCALE_MESO_ID}-${SATRAD_REGION_GOES_WEST_ID}`
...
export const SATRAD_MAP_OPTIONS = [
	{
		...
		options: [
			...
			{
				label: 'Mesoscale',
				value: SATRAD_SCALE_REGION_MESO_EAST_ID,
			},
		],
	},
	{
		...
		options: [
			...
			{
				label: 'Mesoscale',
				value: SATRAD_SCALE_REGION_MESO_WEST_ID,
			},
		],
	},
	{
...
export const SATRAD_SCALE_REGIONS = {
	...
	[SATRAD_SCALE_REGION_MESO_EAST_ID]: {
		region: SATRAD_REGIONS[SATRAD_REGION_GOES_EAST_ID],
		sectors: Object.keys(SATRAD_SECTORS_MESO_GOES_EAST).map((sectorId) => sectorId),
	},
	[SATRAD_SCALE_REGION_MESO_WEST_ID]: {
		region: SATRAD_REGIONS[SATRAD_REGION_GOES_WEST_ID],
		sectors: Object.keys(SATRAD_SECTORS_MESO_GOES_WEST).map((sectorId) => sectorId),
	},

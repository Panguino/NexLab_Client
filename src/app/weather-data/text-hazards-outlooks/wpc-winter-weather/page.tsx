...
import WinterHazardsViewToggle from '@/components/blocks/WinterHazards/WinterHazardsViewToggle/WinterHazardsViewToggle'
import { prepareAlertsFromAPI } from '@/util/hazardMapUtils'
import { AllGeoJSON, rewind } from '@turf/turf'

/**
 * Winter Weather Hazards page with Map/Table toggle
 */
const Page = async () => {
	// Fetch hazard data
	...
	return <WinterHazardsViewToggle alerts={alerts} displayOffshores={displayOffshores} />
}

...
import HydrologicalHazardsViewToggle from '@/components/blocks/HydrologicalHazards/HydrologicalHazardsViewToggle/HydrologicalHazardsViewToggle'
import { prepareAlertsFromAPI } from '@/util/hazardMapUtils'
import { AllGeoJSON, rewind } from '@turf/turf'

/**
 * Hydrological Hazards page with Map/Table toggle
 */
const Page = async () => {
	// Fetch hazard data
	...
	return <HydrologicalHazardsViewToggle alerts={alerts} displayOffshores={displayOffshores} />
}

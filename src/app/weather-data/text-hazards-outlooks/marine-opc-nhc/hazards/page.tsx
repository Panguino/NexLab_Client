...
import MarineHazardsViewToggle from '@/components/blocks/MarineHazards/MarineHazardsViewToggle/MarineHazardsViewToggle'
...
const Page = async () => {
	...
	return <MarineHazardsViewToggle alerts={alerts} displayOffshores={displayOffshores} />
}
